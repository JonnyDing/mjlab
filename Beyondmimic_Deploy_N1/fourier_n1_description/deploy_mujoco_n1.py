...
if __name__ == "__main__":
  ...
  motion_file = "/home/djw/Desktop/mjlab/Beyondmimic_Deploy_N1/model/motions/motion.npz"
  ...
  policy_path = "/home/djw/Desktop/mjlab/Beyondmimic_Deploy_N1/model/policys/2025-10-22_23-42-45.onnx"
  ...
  with mujoco.viewer.launch_passive(m, d) as viewer:
    ...
    while viewer.is_running() and time.time() - start < simulation_duration:
      ...
      if counter % control_decimation == 0:
        ...
        motionposcurrent = motionpos[timestep, 13, :]
        motionquatcurrent = motionquat[timestep, 13, :]
        anchor_quat = subtract_frame_transforms_mujoco(
          position, quaternion, motionposcurrent, motionquatcurrent, init_to_world
        )[1]
